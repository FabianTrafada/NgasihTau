...
const StepIndicator = () => {
  ...
  const steps = [
    { id: Step.General, label: '01', title: t('stepCore') },
    { id: Step.Material, label: '02', title: t('stepAssets') },
    { id: Step.Configurator, label: '03', title: t('stepDeploy') },
  ];
          ...
          {steps.map((step) => {
            ...
            return (
              <div key={step.id} className="flex flex-col items-center">
                <div
                  className={`w-6 h-6 md:w-12 md:h-12 border-4 transition-all duration-500 flex items-center justify-center font-black text-xs md:text-xl ${isCompleted
