...
//   return (
//     <div onClick={handleCardClick} className={`p-6 flex flex-col md:flex-row md:items-start gap-4 transition-colors hover:bg-zinc-50/50 ${!isLast ? "border-b border-black" : ""} cursor-progress`}>
//       {/* Content Section */}
