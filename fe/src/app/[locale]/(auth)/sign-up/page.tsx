                ...
                <div className="relative">
                    ...
                    <div className="bg-white rounded-2xl p-6 relative border-2 border-[#2B2D42] overflow-hidden">
                        ...
                        <div className="text-center mb-4">
                            <h1 className="text-xl font-bold font-(family-name:--font-plus-jakarta-sans)">
                        ...
                        {/* Create Account Text */}
                        <div className="text-center mb-4">
                            <h2 className="text-2xl font-bold font-(family-name:--font-plus-jakarta-sans)">
                                <span className="text-[#2B2D42] ">{t('createAccount').split(' ')[0]} </span>
                                <span className="text-[#FF8811]">{t('createAccount').split(' ').slice(1).join(' ')}</span>
                            </h2>
                            <p className="text-gray-500 text-xs mt-1 font-(family-name:--font-inter)">
                                {t('enterDetails')}
                            </p>
                        </div>
                        ...
                        <form onSubmit={handleSubmit} className="space-y-3">
                            ...
                            <div>
                                <label
                                    htmlFor="name"
                                    className="block text-xs font-semibold text-[#2B2D42] mb-1 font-(family-name:--font-plus-jakarta-sans)"
                                >
                                    {t('name')}
                                </label>
                                <input
                                    ...
                                    className={`w-full text-[#2B2D42] px-3 py-2 border-2 rounded-md focus:outline-none transition-all font-(family-name:--font-inter) bg-white text-sm ${getFieldError("name") ? "border-red-400" : "border-gray-300 focus:border-[#FF8811] focus:shadow-[3px_3px_0px_0px_rgba(255,136,17,1)]"
                                        }`}
                                    placeholder=""
                                    required
                                />
                                {getFieldError("name") && (
                                    <p className="text-red-500 text-[10px] mt-0.5">{getFieldError("name")}</p>
                                )}
                            </div>
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    className={`w-full text-[#2B2D42] px-3 py-2 border-2 rounded-md focus:outline-none transition-all font-(family-name:--font-inter) bg-white text-sm ${getFieldError("email") ? "border-red-400" : "border-gray-300 focus:border-[#FF8811] focus:shadow-[3px_3px_0px_0px_rgba(255,136,17,1)]"
                                        }`}
                                    placeholder=""
                                    required
                                />
                                {getFieldError("email") && (
                                    <p className="text-red-500 text-[10px] mt-0.5">{getFieldError("email")}</p>
                                )}
                            </div>
                            ...
                            <div>
                                ...
                                <div className="relative">
                                    <input
                                        ...
                                        className={`w-full text-[#2B2D42] px-3 py-2 border-2 rounded-md focus:outline-none transition-all pr-10 font-(family-name:--font-inter) bg-white text-sm ${getFieldError("password") ? "border-red-400" : "border-gray-300 focus:border-[#FF8811] focus:shadow-[3px_3px_0px_0px_rgba(255,136,17,1)]"
                                            }`}
                                        placeholder=""
                                        required
                                    />
                                ...
                                {getFieldError("password") && (
                                    <p className="text-red-500 text-[10px] mt-0.5">{getFieldError("password")}</p>
                                )}
                            </div>
                            ...
                            <button
                                type="submit"
                                disabled={loading}
                                className="w-full cursor-pointer bg-[#FF8811] text-white py-2 rounded-lg font-bold transition-all font-(family-name:--font-plus-jakarta-sans) disabled:opacity-50 disabled:cursor-not-allowed border-2 border-[#2B2D42] shadow-[3px_3px_0px_0px_rgba(43,45,66,1)] hover:shadow-[2px_2px_0px_0px_rgba(43,45,66,1)] hover:translate-x-px hover:translate-y-px active:shadow-none active:translate-x-[3px] active:translate-y-[3px] text-sm"
                            >
                        ...
                        <div className="flex items-center my-4">
                            ...
                            <span className="px-3 text-gray-400 text-[10px] font-bold font-(family-name:--font-inter)">{t('orRegisterWith')}</span>
                            <div className="flex-1 border-t-2 border-gray-200"></div>
                        </div>
                        ...
                        <button
                            ...
                            disabled={loading}
                            className="w-full cursor-pointer flex items-center justify-center gap-2 px-4 py-2 border-2 border-[#2B2D42] rounded-lg bg-white transition-all font-(family-name:--font-inter) disabled:opacity-50 disabled:cursor-not-allowed shadow-[3px_3px_0px_0px_rgba(43,45,66,1)] hover:shadow-[2px_2px_0px_0px_rgba(43,45,66,1)] hover:translate-x-px hover:translate-y-px active:shadow-none active:translate-x-[3px] active:translate-y-[3px] text-sm"
                        >
                        ...
                        {/* Login Link */}
                        <p className="text-center mt-4 text-gray-500 text-[11px] font-(family-name:--font-inter)">
                            {t('hasAccount')}{" "}
                            <Link
                                href="/sign-in"
                                className="text-[#FF8811] font-bold hover:text-[#FF8811]/80 transition-colors hover:underline hover:underline-offset-2"
                            >
                                {t('loginNow')}
                            </Link>
                        </p>
