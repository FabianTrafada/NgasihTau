...
export default function SignUpPage() {
    ...
    return (
        <div className="w-full max-w-7xl mx-auto px-4">            {/* Card Container with Brutalist shadow */}
                ...
                <div className="bg-white rounded-2xl p-8 relative border-2 border-[#2B2D42]">
                    ...
                    <form onSubmit={handleSubmit} className="space-y-5">
                        ...
                        <div>
                            ...
                            <p className="text-gray-400 text-xs mt-1">{t('passwordMinLength')}</p>
                        </div>
                    ...
                    <div className="flex items-center my-6">
                        ...
                        <span className="px-4 text-gray-500 text-sm font-[family-name:var(--font-inter)]">{t('orRegisterWith')}</span>
                        <div className="flex-1 border-t border-gray-300"></div>
                    </div>
