...
export default function SignUpPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Registration successful - redirect to verify email with email param
      ...
      <div className="relative">
        ...
        <div className="bg-white rounded-2xl p-8 relative border-[2px] border-[#2B2D42]">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-gray-500 text-sm mt-2 font-[(family-name:var(--font-inter))]">Enter your details to create a new account.</p>
          </div>

          {/* API Error Display */}
          {error && <div className="mb-4 p-3 bg-red-50 border border-red-200 rounded-lg text-red-600 text-sm">{error.message}</div>}

          {/* Form */}
          <form onSubmit={handleSubmit} className="space-y-5">
            {/* Name Field */}
            <div>
              <label htmlFor="name" className="block text-sm font-semibold text-[#2B2D42] mb-2 font-[(family-name:var(--font-plus-jakarta-sans))]">
                Full Name
              </label>
              <input
                type="text"
            ...
            {/* Email Field */}
            <div>
              <label htmlFor="email" className="block text-sm font-semibold text-[#2B2D42] mb-2 font-[family-name:var(--font-plus-jakarta-sans)]">
                Email
              </label>
              <input
                type="email"
            ...
            {/* Password Field */}
            <div>
              <label htmlFor="password" className="block text-sm font-semibold text-[#2B2D42] mb-2 font-[family-name:var(--font-plus-jakarta-sans)]">
                Password
              </label>
              <div className="relative">
                <input
                  ...
                  required
                />
                <button type="button" onClick={() => setShowPassword(!showPassword)} className="cursor-pointer absolute right-4 top-1/2 -translate-y-1/2 text-gray-400 hover:text-gray-600 transition-colors">
                  {showPassword ? (
          ...
          <div className="flex items-center my-6">
            ...
            <span className="px-4 text-gray-500 text-sm font-[family-name:var(--font-inter)]">Or Register With</span>
            <div className="flex-1 border-t border-gray-300"></div>
          </div>
          ...
          >
            <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path
                d="M19.8055 10.2275C19.8055 9.51803 19.7477 8.83551 19.6399 8.17969H10.2002V12.0494H15.6006C15.3681 13.2994 14.6259 14.3578 13.5379 15.0672V17.5766H16.8055C18.7054 15.8369 19.8055 13.2713 19.8055 10.2275Z"
                fill="#4285F4"
              />
              <path
                d="M10.2002 20.0003C12.9002 20.0003 15.1719 19.1044 16.8055 17.5763L13.5379 15.0669C12.6215 15.6669 11.4845 16.0213 10.2002 16.0213C7.59478 16.0213 5.38234 14.2631 4.57289 11.9004H1.20312V14.4907C2.83212 17.7594 6.26791 20.0003 10.2002 20.0003Z"
                fill="#34A853"
              />
              <path
                d="M4.57289 11.9003C4.37289 11.3003 4.25952 10.659 4.25952 10.0003C4.25952 9.34155 4.37289 8.70023 4.57289 8.10023V5.50977H1.20312C0.437559 6.85977 0 8.38629 0 10.0003C0 11.6143 0.437559 13.1408 1.20312 14.4908L4.57289 11.9003Z"
                fill="#FBBC04"
              />
              <path
                d="M10.2002 3.97898C11.5997 3.97898 12.8545 4.47898 13.8386 5.45896L16.8767 2.42091C15.168 0.919312 12.8963 0 10.2002 0C6.26791 0 2.83212 2.24091 1.20312 5.50958L4.57289 8.10004C5.38234 5.73725 7.59478 3.97898 10.2002 3.97898Z"
                fill="#E94235"
              />
            </svg>
          ...
          <p className="text-center mt-6 text-gray-600 text-sm font-[family-name:var(--font-inter)]">
            ...
            <Link href="/sign-in" className="text-[#FF8811] font-semibold hover:text-[#FF8811]/80 transition-colors">
              Login Now
            </Link>
          </p>
        </div>
