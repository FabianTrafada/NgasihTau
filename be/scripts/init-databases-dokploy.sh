#!/bin/bash
# ===========================================
# PostgreSQL Initialization for Dokploy
# ===========================================
# Simplified version that uses environment variables for passwords
# Upload this to Dokploy File Mounts as "init-databases.sh"
